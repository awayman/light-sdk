...
include(":examples:home-assistant")
project(":examples:home-assistant").projectDir = file("examples/home-assistant")
include(":examples:frigate")
project(":examples:frigate").projectDir = file("examples/frigate")
